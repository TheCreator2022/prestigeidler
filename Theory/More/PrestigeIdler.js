...
var id = "prestigeidler";
var name = "Prestige Idler";
var description = "Hey guys This With Throngjwk \nThis Prestige tree?!";
var authors = "Karen";
var version = 1;
...
var init = () => {
    ...
    ///////////////////
    //// Story chapters
    chapter1 = theory.createStoryChapter(0, "Changelog", "v0.0.4: \nPrivate Bulids.", () => c1.level > 0);
...
var getC1 = (level) => Utils.getStepwisePowerSum(level, 2, 100, 1);
